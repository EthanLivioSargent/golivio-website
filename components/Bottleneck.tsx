        ...
        <div className="lg:col-span-7 lg:pt-2">
          ...
          <Reveal delay={3}>
            <p className="section-deck mt-5 max-w-prose text-text-mid">
              Livio collapses that buildout into a repeatable factory process. We pre-engineer the shell off-site, assemble it on-site like LEGO, and bring the data, vendors, and schedule under a single command line — so a project doesn&rsquo;t slip because a transformer quote took six weeks to come back.
            </p>
          </Reveal>
          <Reveal delay={4}>
            <ul className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
              {[
                ...
                <li key={c.label} className="card-light lift p-6">
                  <div className="font-mono text-[1.75rem] font-bold text-gold-700">{c.num}</div>
                  <div className="mt-2 text-[16px] font-semibold text-text-hi">{c.label}</div>
