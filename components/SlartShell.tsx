...
export default function SlartShell() {
  ...
  return (
    ...
    >
      {/* faux window chrome */}
      <div className="mb-3 flex items-center gap-2 border-b border-line2 pb-3">
        <span className="h-2.5 w-2.5 rounded-full bg-[#ff5f57]" aria-hidden />
        <span className="h-2.5 w-2.5 rounded-full bg-[#febc2e]" aria-hidden />
        <span className="h-2.5 w-2.5 rounded-full bg-[#28c840]" aria-hidden />
        <span className="ml-3 select-none font-mono text-[11px] uppercase tracking-[0.18em] text-ink-dim">
          slart — the livio shell
        </span>
        <span className="ml-auto rounded border border-gold/30 bg-gold/10 px-1.5 py-[1px] font-mono text-[10px] font-bold text-gold">
          v1.0
        </span>
      </div>
